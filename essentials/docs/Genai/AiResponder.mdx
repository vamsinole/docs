---
title: AI Responder
description: Configure AI-powered responses for email and other channels in ContactSwing, including setup and best practices.
---

## Overview

Set up AI Responder to draft, personalize, and insert AI-generated replies across channels. This guide covers integration, generation, and insertion flows.
...
<Steps>
  ...
  <Step title="Open and read an email">
  ...
  <Step title="Review and insert the AI-generated response">
