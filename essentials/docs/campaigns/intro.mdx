...
Learn how to effectively manage and optimize your communication campaigns. This guide provides an overview of campaign features and best practices.
...
- **[📞 Call Campaign](./call)**: Automate or schedule voice calls (e.g., follow-ups, reminders) to reach customers at the right time
- **[✉️ Email Campaign](./email)**: Set up automated or personalized email campaigns to engage customers, provide updates, or offer promotions
- **[💬 SMS Campaign](./sms)**: Manage SMS campaigns for direct communication, automating responses or sending marketing messages
