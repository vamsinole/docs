...
<div class="card-video">
  <video src="https://storage.googleapis.com/helpsessionvideos/Contactswing/Videos/Integration/HubSpot/hubspot-integration.mp4" autoplay playsinline controls title="HubSpot Integration"></video>
</div>
...
<Steps>
  <Step title="Go to the Integrations section">
    ...
    <img src="https://storage.googleapis.com/helpsessionvideos/Contactswing/images/Integration/Hubspot/hubspot1.jpg" alt="Integrations" />
  </Step>
  <Step title="Sign in to your HubSpot account">
    ...
    <img src="https://storage.googleapis.com/helpsessionvideos/Contactswing/images/Integration/Hubspot/hubspot2.jpg" alt="HubSpot login" />
  </Step>
  <Step title="Create or sign in to HubSpot">
  ...
  <Step title="Choose an account for Contactswing">
