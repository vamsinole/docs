...
description: Integrate ContactSwing with Zoho Bigin to run AI-powered multi-channel campaigns from within Bigin using a stored extension auth key.
---
...
- Configure authentication tokens for secure API access
...
- Seamless integration with Bigin campaign workflows
