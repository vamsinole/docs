...
description: Connect Twilio to ContactSwing to manage numbers and power multi-channel communications for AI agents and campaigns.
---

## Overview

Configure Twilio with ContactSwing to enable SMS, voice, and WhatsApp channels for agents and campaigns. This page covers connection steps and how to use Twilio in your workflows.

Learn how to connect and configure Twilio with ContactSwing. This guide shows you how to set up and use Twilio integration effectively.

### 🎥 Video walkthrough

<div class="card-video">
  <video src="https://storage.googleapis.com/helpsessionvideos/Contactswing/Videos/Integration/Twilio/twilio-integration.mp4" autoplay playsinline controls title="Twilio Integration Overview"></video>
</div>
...
<Steps>
  <Step title="Go to the Integrations section">
    ...
    <img src="https://storage.googleapis.com/helpsessionvideos/Contactswing/images/Integration/Twilio/twilio1.jpg" alt="Integrations" />
  </Step>
  <Step title="Select Twilio and connect your account">
    ...
    <img src="https://storage.googleapis.com/helpsessionvideos/Contactswing/images/Integration/Twilio/twilio2.jpg" alt="Twilio API" />
  </Step>
