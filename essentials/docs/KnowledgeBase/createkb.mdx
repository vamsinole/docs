...
<Steps>
  ...
  <Step title="Add content to your Knowledge Base">
    Once your knowledge base is created, you can add content in three ways: FAQs, files, and URLs.
    ...
    <Tabs>
      ...
      <Tab title="Add Files">
        Learn how to enhance your knowledge base by adding files.
      ...
      <Tab title="Add URL">
        Learn how to enhance your knowledge base by adding URLs.
