# ClickUp to Contactswing Phone Call

Supercharge your task management workflows by connecting **ClickUp** to **Contactswing**. With this integration, you can automatically trigger a **phone call** in Contactswing when key task events (like creation, status update, or deletion) happen in ClickUp — keeping your team or clients informed instantly with AI-driven calling.
